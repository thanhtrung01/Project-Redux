...
import instaImg1 from "../image/insta-1.jpg.webp";
import instaImg2 from "../image/insta-2.jpg.webp";
import instaImg3 from "../image/insta-3.jpg.webp";
  ...
  return (
    <footer className="footer">
      <div className="banner-footer gap-px grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 w-full">
        <div className="relative">
          ...
          <div className="opacity-0 banner-footer-item absolute items-center inset-0 hover:bg-white hover:opacity-80">
            <div className="flex justify-center items-center w-full h-full">
              <div className="footer-insta-content absolute text-black">
                <div className="flex justify-center">
                  <AiOutlineInstagram className="text-3xl mb-2" />
                </div>
        ...
        <div className="relative">
          <img className="w-full" src={instaImg2}></img>
          <div className="opacity-0 banner-footer-item absolute items-center inset-0 hover:bg-white hover:opacity-80">
            <div className="flex justify-center items-center w-full h-full">
              <div className="footer-insta-content absolute text-black">
                <div className="flex justify-center">
        ...
        <div className="relative">
          <img className="w-full" src={instaImg3}></img>
          <div className="opacity-0 banner-footer-item absolute items-center inset-0 hover:bg-white hover:opacity-80">
            <div className="flex justify-center items-center w-full h-full">
              <div className="footer-insta-content absolute text-black">
                <div className="flex justify-center">
        ...
        <div className="relative">
          <img className="w-full" src={instaImg4}></img>
          <div className="opacity-0 banner-footer-item absolute items-center inset-0 hover:bg-white hover:opacity-80">
            <div className="flex justify-center items-center w-full h-full">
              <div className="footer-insta-content absolute text-black">
                <div className="flex justify-center">
        ...
        <div className="relative">
          <img className="w-full" src={instaImg5}></img>
          <div className="opacity-0 banner-footer-item absolute items-center inset-0 hover:bg-white hover:opacity-80">
            <div className="flex justify-center items-center w-full h-full">
              <div className="footer-insta-content absolute text-black">
                <div className="flex justify-center">
        ...
        <div className="relative">
          <img className="w-full" src={instaImg6}></img>
          <div className="opacity-0 banner-footer-item absolute items-center inset-0 hover:bg-white hover:opacity-80">
            <div className="flex justify-center items-center w-full h-full">
              <div className="footer-insta-content absolute text-black">
                <div className="flex justify-center">
